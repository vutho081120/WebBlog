                ...
                <form class="card" action="<?php echo e(route('admin.user.create')); ?>" method="POST">
                    ...
                    <div class="card-body">
                        ...
                        <div class="mb-3">
                            ...
                            <div class="row g-2">
                                <div class="col-5">
                                    <select name="userMonth" class="form-select">
                                        <option value="1">Tháng 1</option>
                                        <option value="2">Tháng 2</option>
                                        <option value="3">Tháng 3</option>
                                        <option value="4">Tháng 4</option>
                                        <option value="5">Tháng 5</option>
                                        <option selected="selected" value="6">Tháng 6</option>
                                ...
                                <div class="col-3">
                                    <select name="userDay" class="form-select">
                                ...
                                <div class="col-4">
                                    <select name="userYear" class="form-select">
