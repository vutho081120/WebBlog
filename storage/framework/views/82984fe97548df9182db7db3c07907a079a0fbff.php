...
<div class="container container-tight py-4">
    <div class="text-center mb-4">
        <a href="<?php echo e(route('site.home.index')); ?>" class="navbar-brand navbar-brand-autodark"><img
                src="<?php echo e(asset('images/Admin/logo.svg')); ?>" height="36" alt=""></a>
    </div>
    <div class="card card-md">
        <div class="card-body">
            <h2 class="h2 text-center mb-4">Login to your account</h2>
            <form action="<?php echo e(route('site.account.login')); ?>" method="post" autocomplete="off" novalidate="">
                <?php echo csrf_field(); ?>
                <div class="mb-3">
                    <label class="form-label">Phone</label>
                    <div>
                        <?php if($errors->has('phoneLogin')): ?>
                            <input type="tel" class="form-control is-invalid" aria-describedby="phoneHelp"
                                name="phoneLogin" placeholder="Enter phone">
                            <div class="invalid-feedback"><?php echo e($errors->first('phoneLogin')); ?></div>
                        <?php else: ?>
...
<?php /**PATH C:\xampp\htdocs\WebBlog\resources\views/Site/Components/Login.blade.php ENDPATH**/ ?>