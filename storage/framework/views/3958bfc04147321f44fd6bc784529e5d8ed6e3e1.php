    ...
    <div class="collapse navbar-collapse" id="navbar-menu">
        <div class="navbar">
            <div class="container-xl">
                <ul class="navbar-nav">
                    <li class="nav-item">
                        <a class="nav-link" href="<?php echo e(route('admin.home.index')); ?>">
                            <span
...
<?php /**PATH C:\xampp\htdocs\WebBlog\resources\views/Admin/Components/PageMenus/HorizontalBar.blade.php ENDPATH**/ ?>