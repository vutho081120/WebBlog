...
<header class="navbar navbar-expand-sm navbar-light d-print-none">
    <div class="container-xl">
        <h1 class="navbar-brand navbar-brand-autodark d-none-navbar-horizontal pe-0 pe-md-3">
            <a href="#">
                <img src="<?php echo e(asset('images/Admin/logo.svg')); ?>" width="110" height="32" alt="Tabler"
        ...
        <div class="navbar-nav flex-row order-md-last">
            <div class="d-none d-md-flex">
                <a href="<?php echo e(route('site.account.logout')); ?>" class="nav-link px-0" aria-label="Logout"
                    data-bs-toggle="tooltip" data-bs-placement="bottom" data-bs-original-title="Logout">
            ...
            <div class="nav-item">
                <a href="#" class="nav-link d-flex lh-1 text-reset p-0">
                    ...
                    <div class="d-none d-xl-block ps-2">
                        <div><?php echo e(Auth::user()->user_name); ?></div>
                        <div class="mt-1 small text-secondary"><?php echo e(Auth::user()->role); ?></div>
                    </div>
                </a>
            </div>
        </div>
...
<?php /**PATH C:\xampp\htdocs\WebBlog\resources\views/Admin/Components/PageMenus/NavBar.blade.php ENDPATH**/ ?>