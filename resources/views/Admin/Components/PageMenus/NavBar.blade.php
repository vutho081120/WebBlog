...
<header class="navbar navbar-expand-sm navbar-light d-print-none">
    <div class="container-xl">
        <h1 class="navbar-brand navbar-brand-autodark d-none-navbar-horizontal pe-0 pe-md-3">
            <a href="#">
                <img src="{{ asset('images/Admin/logo.svg') }}" width="110" height="32" alt="Tabler"
        ...
        <div class="navbar-nav flex-row order-md-last">
            <div class="d-none d-md-flex">
                <a href="{{ route('site.account.logout') }}" class="nav-link px-0" aria-label="Logout"
                                    ...
                                    <div class="row align-items-center">
                                        <div class="col text-truncate">
                                            <a href="{{ route('change-language', 'en') }}"
                                                class="btn btn-ghost-light text-body d-block">{{ __('English') }}</a>
                                        </div>
                                    </div>
                                </div>
                                <div class="list-group-item">
                                    <div class="row align-items-center">
                                        <div class="col text-truncate">
                                            <a href="{{ route('change-language', 'vi') }}"
                                                class="btn btn-ghost-light text-body d-block">{{ __('Vietnam') }}</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
