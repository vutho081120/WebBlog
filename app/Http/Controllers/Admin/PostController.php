...
class PostController extends Controller
{
    ...
    public function createShow()
    {
        ...
        return view('Admin.Pages.PostCreate', compact('categoryList'));
    }
    ...
    public function editShow($id)
    {
        ...
        return view('Admin.Pages.PostEdit', compact('postItem', 'categoryList'));
    }
    ...
    public function search(Request $request)
    {
        ...
        return view('Admin.Pages.PostSearch', compact('postList'));
    }
